...
SELECT
	...
	offensive_possessions / factor AS offensive_possessions_40min,
	defensive_possessions / factor AS defensive_possessions_40min,
    possessions / factor AS possessions_40min
FROM base